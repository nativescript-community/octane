...
| Package                                               | What it is                                                                                                                            |
| ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| [`@nativescript/vite-octane`](./packages/vite-octane) | The Octane flavor for `@nativescript/vite`: the config helper and the Vite HMR strategy that hot-updates Octane components on device. |
...
npx nx test @nativescript/vite-octane
```
